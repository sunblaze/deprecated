...
class Google::Protobuf::GeneratedCodeInfo
  sig { params(annotation: T.any(Google::Protobuf::RepeatedField[Google::Protobuf::GeneratedCodeInfo::Annotation], T::Array[Google::Protobuf::GeneratedCodeInfo::Annotation])).void }
  ...
  sig { params(value: Google::Protobuf::RepeatedField[Google::Protobuf::GeneratedCodeInfo::Annotation]).returns(Google::Protobuf::RepeatedField[Google::Protobuf::GeneratedCodeInfo::Annotation]) }
